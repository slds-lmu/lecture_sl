...
\newcommand{\learninggoals}{
  \item Recall that the hypothesis space is the set of all admissible functions
  \item Know the hypothesis space for: linear regression, separating hyperplanes, decision trees, ensembles, and neural networks
}
