...
# Draw a 3 points in a horizontal line in a 2d graphic and the horizontal line and add an axis
...
plot(0, 0, type="n", xlim=c(-2, 4), ylim=c(-0.5, 0.5), xlab="", ylab="", axes=F)
