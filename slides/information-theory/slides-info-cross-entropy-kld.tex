...
\begin{frame}[allowframebreaks]{Cross-Entropy - Discrete Case}
...
\item $D_{KL}(p \| q)$: Difference between the two
...
\begin{frame}{Cross-Entropy - Continuous Case}
...
\begin{frame}{Cross-Entropy Example}
...
\begin{frame}[allowframebreaks]{Proof: Maximum of Differential Entropy}
...
% \begin{frame} {Cross-Entropy - Summary}
%   \begin{itemize}
