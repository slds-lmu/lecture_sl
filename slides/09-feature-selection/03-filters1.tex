...
\begin{framev}{Introduction}
  ...
  \begin{framev}{Pearson \& Spearman correlation}
...
%   \end{vbframe}
  ...
  \begin{framev}{Welch's \MakeLowercase{t}-test}
  \begin{itemize}
...
%\footnotesize{Visualization of t-test scores.}
  ...
  \begin{framev}{Mutual Information (MI)}
