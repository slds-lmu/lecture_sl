...
\title{
  \hspace{-0.5cm}\centerline{\includegraphics[width=0.8\paperwidth,keepaspectratio, trim={0 15cm 0 5cm}, clip]{titlepage.jpg}}
  \medskip
  Supervised Learning \\
  \medskip
  \small All slides
...
\input{../advriskmin/chapter-order-slides-all.tex}

\section{Multiclass Classification}
\input{../multiclass/chapter-order.tex}

\section{Information Theory}
\input{../information-theory/chapter-order.tex}

\section{Curse of Dimensionality}
\input{../cod/chapter-order.tex}

%\section{Hypothesis Space}
%\input{..//hypospaces-capacity/chapter-order.tex}

\section{Regularization}
\input{../regularization/chapter-order.tex}

\section{Linear Support Vector Machine}
\input{../linear-svm/chapter-order.tex}
