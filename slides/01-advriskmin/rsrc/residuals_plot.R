...
# FIG: residuals of reg on l1, l2, huber loss
# ------------------------------------------------------------------------------
...
# Title figures 
# ggsave("../figure/residuals_plot_L1_title.png", p$grobs[[1]], width = 4, height = 3)

p <- plotResiduals("L2")
ggsave("../figure/residuals_plot_L2.pdf", p, width = 8, height = 4)
# Title figures 
ggsave("../figure/residuals_plot_L2_title.png", p$grobs[[1]] , width = 4, height = 3)
