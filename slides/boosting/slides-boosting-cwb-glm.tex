...
\lecturechapter{Gradient Boosting: CWB and GLMs}
...
But: We do not \emph{require} an exponential family distribution and we can - in principle - to any differentiable loss %and thus are able to fit models
