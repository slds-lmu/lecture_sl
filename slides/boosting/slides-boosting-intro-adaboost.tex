...
the existence of a strong learner?} \citelink{KEARNSOUR}
...
\item We call a learner a \textbf{strong learner} \enquote{if there exists a polynomial-time algorithm that achieves low error with high confidence for all concepts in the class} \citelink{SCHAPIRE1990STRENGTH}.
...
\begin{itemize}
  \item The \textbf{AdaBoost} (Adaptive Boosting) algorithm is a \textbf{boosting} method
    for binary classification by \citelink{FREUND1996EXPERIMENTS}.
