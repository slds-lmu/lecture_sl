...
\begin{itemize}
    \item This also implies that for very correlated features in lasso through a unit change we could arbitrarily force a feature out of he model
\end{itemize}
...
\item \citebutton{Tibshirani, 1996}{https://www.jstor.org/stable/2346178} \citebutton{Zou and Hastie, 2005}{https://rss.onlinelibrary.wiley.com/doi/abs/10.1111/j.1467-9868.2005.00503.x}
\end{itemize}
