...
\titlemeta{% Chunk title (example: CART, Forests, Boosting, ...), can be empty
  ...
  figure/graddes_vs_weightdecay.png
  }{
...
\begin{figure}
  \subfloat[Gradeint descent over $R_{emp}$]{\includegraphics[width=0.45\textwidth]{figure/graddes_vs_weightdecay_01.png}}
  \subfloat[Weight decay over $R_{emp}$]{\includegraphics[width=0.45\textwidth]{figure/graddes_vs_weightdecay_02.png}}\\
  \caption*{}
\end{figure}
...
\begin{figure}
  \subfloat[Weight decay (small $\lambda$) over $R_{emp}$]{\includegraphics[width=0.45\textwidth]{figure/weightdecay_lambda_plot_01.png}}
  \subfloat[Weight decay (large $\lambda$) over $R_{emp}$]{\includegraphics[width=0.45\textwidth]{figure/weightdecay_lambda_plot_02.png}}\\
\end{figure}
