...
\titlemeta{% Chunk title (example: CART, Forests, Boosting, ...), can be empty
  ...
  figure_man/lasso_ridge_hat.png
  }{
...
{\small
$$y = \xv^{\top} \thetab + \bm{\varepsilon}\,,\quad \thetab =(4,-4,-2,2,0,\ldots,0)^{\top} \in \mathbb{R}^{1500}, \quad x_j,\varepsilon \sim \mathcal{N}(0,1)$$
}
\vspace{-1cm}
...
\textbf{Conclusion}: lasso underestimates true coefficient magnitudes while SCAD/MCP achieve unbiased estimation and better variable selection
