...
\lecturechapter{Regularization:\\ Bayesian Priors}
...
\begin{itemize}
  ...
  \item Elastic-net regularization corresponds to a compromise between Gaussian and Laplacian priors \citebutton{Zou and Hastie, 2005}{https://rss.onlinelibrary.wiley.com/doi/abs/10.1111/j.1467-9868.2005.00503.x}
  \citebutton{Hans, 2011}{https://www.jstor.org/stable/23239545}
\end{itemize}
 }
