...
\titlemeta{% Chunk title (example: CART, Forests, Boosting, ...), can be empty
  ...
  \item Understand regularized empirical risk minimization 
}
...
\setlength{\itemsep}{1.0em}
    ...
    \item \textbf{Structured regularization} methods incorporate structural prior knowledge over groups of parameters or subnetworks (e.g., group lasso \citebutton{Yuan and Lin, 2005}{https://rss.onlinelibrary.wiley.com/doi/abs/10.1111/j.1467-9868.2005.00532.x})
\end{itemize}
...
We train a shallow neural network with one hidden layer and 100 hidden units as well as an SVM with RBF kernel (and $C=10^6, \gamma=10$) on a small regression task. No form of explicit regularization is imposed on the models. %The target variable is house price.
\vspace{0.2cm}
\begin{table}[ht]
\centering
\begin{tabular}{rrr}
