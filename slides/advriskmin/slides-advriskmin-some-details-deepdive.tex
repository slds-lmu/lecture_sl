...
\begin{framev}[small]{Equivalence of loss formulations}
...
\begin{framev}[small]{Proof Risk Minimizer on Scores}
...
\begin{framev}[small]{Binary log loss: Emp. Risk Minimizer}
