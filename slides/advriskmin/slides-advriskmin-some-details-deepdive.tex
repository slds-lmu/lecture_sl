...
\begin{framev}[fs=small]{Equivalence of loss formulations}
...
\begin{framev}[fs=small]{Proof Risk Minimizer on Scores}
...
\begin{framev}[fs=small]{Binary log loss: Emp. Risk Minimizer}
