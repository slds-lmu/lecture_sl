...
\begin{itemize}
  ...
  = &1 - 2yf + (yf)^2 = (1 - yf)^2
  \end{eqnarray*}
  \item This loss behaves just like the squared hinge loss for $yf < 1$, but is not clipped to $0$ for $yf>1$ (zero only for $yf = 1$ and increases again in $yf$ which is in general not desirable!)
\end{itemize}
