...
\begin{itemize}
  ...
  = &1 - 2yf + (yf)^2 = (1 - yf)^2
  \end{eqnarray*}
  \item This loss behaves just like the squared hinge loss for $yf < 1$, but 
  is zero only for $yf = 1$ and actually increases again for larger margins (which is in general not desirable!)
\end{itemize}
