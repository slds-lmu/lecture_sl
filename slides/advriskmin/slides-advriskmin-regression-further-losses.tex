...
%What is the optimal constant model $f = \thetab$ w.r.t. the $\epsilon$-insensitive loss $L(y,f) =  |y - f| ~ \mathds{1}_{ \left\{|y - f| > \epsilon \right\}}$?

%\vspace{-0.2cm}
%\begin{eqnarray*}
%\hat \thetab&=& \argmin_{\thetab\in \R}\sumin L(y,f)i \\
