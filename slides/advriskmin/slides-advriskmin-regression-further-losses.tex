...
\begin{framei}[sep=M]{Advanced Loss Functions \citelink{WANG2020COMPRE}}
...
\imageC[0.55]{figure/plot_loss_overview.png}
...
\imageC[0.65]{figure/loss_huber_plot.png}
...
\begin{framei}{Log-cosh Loss \citelink{SALEH2022STATISTICAL}}
...
\begin{frame}{Log-cosh Loss \citelink{SALEH2022STATISTICAL}}
...
{\imageL[1.1]{figure/cosh-gaussian-densities.png}}


\end{frame}

\begin{framei}{Cauchy loss}
...
\begin{framei}{$\eps$-Insensitive loss}
...
\vfill 
% \imageC[10cm, height = 4.7cm]{figure_man/2_6_loss_epsilon_plot1.png} \\
...
\begin{framei}{Quantile Loss / Pinball Loss}
...
% \imageC[10cm, height = 4.7cm]{figure_man/2_3_loss_pinball_plot2.png}
