...
The log-cosh approach obtain a differentiable approximation of the $L1$ loss can also be extended to  differentiable pinball losses (later). For more details on the log-cosh loss, see  \citebutton{Saleh and Saleh, 2024}{https://arxiv.org/pdf/2208.04564}.
...
\begin{figure}
      \centering
        \scalebox{1}{\includegraphics{slides/advriskmin/figure_man/cosh-gaussian-densities.png}}
        %\caption{\footnotesize lasso vs non-convex SCAD and MCP penalties for scalar parameter $\thetab$}
    \end{figure}
