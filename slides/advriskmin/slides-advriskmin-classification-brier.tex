...
The binary Brier score is defined on probabilities $\pi \in [0, 1]$ and 0-1-encoded labels $y \in \{0, 1\}$ and measures their squared distance ($L2$ loss on probabilities).
...
%\vspace{0.2cm}
\begin{center}
\includegraphics[width = 0.55\textwidth]{figure/brier.png}
\end{center}
