...
If probs are transformed into scores as $f = \log\left(\frac{\pi}{1 - \pi}\right)$ (log-odds of $\pi$), we arrive at another equivalent formulation of the loss:
...
\begin{figure}
  \subfloat{\includegraphics[width=0.4\textwidth]{figure/bernoulli_prob.png}}
  \subfloat{\includegraphics[width=0.4\textwidth]{figure/logistic.png}}\\
\end{figure}
\end{center}
...
For different label encoding $y' \in \setmp$, recognize that $y'=2y-1$. Substituting $y'$ into $\Lyf$ yields
\begin{equation*}
