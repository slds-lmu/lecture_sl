...
\begin{itemize}
    ...
    %\item This means finding the optimal model is equivalent to finding the optimal parameter values.
    %\item The relation between optimization over $f \in \Hspace$ %and optimization
%over $\thetav \in \Theta$ allows us to operationalize our search for best model (function) via searching an optimal $\thetav$
