...
\newcommand{\learninggoals}{
	\item Learn the correspondence between a Laplacian error distribution and the L1 loss
	\item Learn that there is no error distribution for the Huber loss
	\item Learn the correspondence between Bernoulli-distributed targets and the Bernoulli loss 
...
\begin{center}
\includegraphics{figure/residuals_plot_Huber_L1.pdf}
\end{center}
