...
\begin{framei}[sep=M]{Prob. Preds / scoring rules \citelink{GNEITING2007}}
...
\begin{framei}[sep=M]{Proper scoring rule \citelink{GNEITING2007}}
...
{\imageL[0.6]{figure/bernoulli_prob.png}}
