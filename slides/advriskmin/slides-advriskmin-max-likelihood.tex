...
\
Formally: Formally, $\thetah \in \argmax_{\thetav} \LL(\thetav) \Leftrightarrow \thetah \in \argmin_{\thetav}-\log(\LL(\thetav))$.  %\implies \thetah \in \argmin_{\thetav}-\log(\LL(\thetav))$
