...
\end{minipage}%
\begin{minipage}{0.5\textwidth}
\includegraphics[width = 0.75\textwidth]{slides/advriskmin/figure/log_reg_ml.pdf}
\end{minipage}
...
\end{minipage}%
\begin{minipage}{0.5\textwidth}
\includegraphics[width = 0.75\textwidth]{slides/advriskmin/figure/log_reg_erm.pdf}
\end{minipage}
\end{itemize}
