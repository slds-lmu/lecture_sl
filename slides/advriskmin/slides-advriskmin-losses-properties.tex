...
\splitVCC[0.4]{
  \imageC{figure/loss_dist_based}
  \tiny \centering
  Distance-based: $L1$
}{
\imageC{figure/overview_classif.png}
  \tiny \centering
  %Margin-based losses
}
...
%  \imageC[]{figure/plot_loss_overview_classif_2}
%  \tiny \centering
%  Margin-based losses
%\end{minipage}%
\splitVThree
...
{
  \imageC{figure/loss_transl_inv.png}
  \tiny \centering
  Translation-invariant: $L2$
}%
{
  \imageC{figure/loss_symmetric}
  \tiny \centering
...
%   \imageC[]{figure/loss_l2_l1_huber.png}
...
% 
% 
% \imageC[0.8]{figure/robustness.png}
% 
...
\splitVCC{
  \imageC[0.9]{figure/overview_classif.png}
}%
{
...
% \end{minipage}%
% \begin{minipage}[b]{0.25}
%   \imageC[]{figure/plot_bernoulli}
% \end{minipage}%
% 
% % \vfill
% % \imageC[0.4]{figure_man/snap_bernoulli_loss}
% % \vfill
% 
% \begin{itemize} 
