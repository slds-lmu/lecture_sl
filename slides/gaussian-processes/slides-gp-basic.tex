...
$$\{Y_t: t \in T\}$$ 
% \item Special instance of indexed families: random state space
...
% \begin{framei}{examples of indexed families}
% \item Sequences: $\mathcal{S} = \R$
% \item Finite sequences (lists): $|T| < \infty$, e.g., $T = \nset$
% \imageL[.5]{figure_man/indexed_family/indexed_family_1.png}
% \item Infinite sequences: $|T| = \infty$, e.g., $T = \N$
% \imageL[.5]{figure_man/indexed_family/indexed_family_2.png}
% \end{framei}

% \begin{framei}{examples of indexed families}
% \item More complicated, e.g., $\mathcal{S}$ is some space over RVs
% \item \textcolor{red}{LW hier<l}
% \item Finite sequences (lists): $|T| < \infty$, e.g., $T = \nset$
% \imageL[.5]{figure_man/indexed_family/indexed_family_1.png}
% \item Infinite sequences: $|T| = \infty$, e.g., $T = \N$
% \imageL[.5]{figure_man/indexed_family/indexed_family_2.png}
