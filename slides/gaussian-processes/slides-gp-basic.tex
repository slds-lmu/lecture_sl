...
figure_man/discrete/marginalization-more2.png
}{
...
% \else
\imageC[.8]{figure_man/discrete/marginalization-more2.png}
% \fi
}

\item Example with 1D (left) and 2D (right) index set $\Xspace$: Dimension of $\fv$ depends on $n$, not on dimension of $\Xspace$:
\splitV{
\imageC{figure_man/indexed_family/indexed_family_52.png}
}{
\imageC[.8]{figure_man/indexed_family/indexed_family_62.png}
}
\vfill
