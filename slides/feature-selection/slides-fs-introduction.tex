...
\newcommand{\learninggoals}{
  \item Understand that adding more features can be detrimental to prediction performance.
...
%  \end{vbframe}
  ...
  \begin{center}
     \includegraphics[width = 0.5\textwidth]{figure_man/avoid_overfitting_02.png}\\
    \end{center}
...
\vspace{0.5cm}
  ...
  \begin{vbframe}{Objective function}
    ...
    \begin{center}
     \includegraphics[width = 0.33\textwidth]{figure_man/searchspace_binary.png}\\
    \end{center}
    %\normalsize
  \end{vbframe} 
