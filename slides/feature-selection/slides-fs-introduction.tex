...
%  \end{vbframe}
  ...
  \framebreak
    ...
    \setlength{\itemsep}{1.0em}
      \item In high-dimensional data sets, we often have prior information that many features are either irrelevant or redundant or of low quality
      \item Features can cost something during prediction %cost something 
      (money or time)
