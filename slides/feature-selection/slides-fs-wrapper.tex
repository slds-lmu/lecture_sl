...
\begin{document}
  ...
  \begin{vbframe}{Introduction}
    ...
    \begin{itemize}
      ...
      \item A wrapper is a discrete search strategy for $S$, where the test error of a learner as a function of $S$ is the objective criterion
    \end{itemize}
    $\Rightarrow$ Use the learner to assess the quality of the feature sets

    \begin{center}
     \includegraphics[width = 0.4\textwidth]{figure/searchspace_binary.png}\\
