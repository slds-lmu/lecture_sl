...
\begin{document}
  ...
  \lecturechapter{Feature Selection: Filter Methods}
  ...
  \begin{itemize}
    ...
    \item The larger $\chi_j^2$, the more dependent is the feature-target combination $\rightarrow$ higher relevancy.
  \end{itemize}
  \end{vbframe}
