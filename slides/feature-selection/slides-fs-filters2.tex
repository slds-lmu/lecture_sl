...
\newcommand{\learninggoals}{
  ...
  \item Understand how filter methods work in practical applications.
}
...
\begin{document}
  ...
  \lecturechapter{Feature Selection: Filter Methods (Examples and Caveats)}
...
\end{comment}
  ...
  \begin{vbframe}{Filter methods can be misleading}
   ...
   \begin{figure}
    ...
    \end{figure}
\vspace{0.3cm}
\footnotesize{\textbf{IG from presumably redundant variables}. 2 class problem with i.i.d. variables. Each class has Gaussian distribution with no covariance. While filter methods suggest redundancy, combination of both vars yields improvement, showing i.i.d. vars are not truly redundant. %Right: After 45 degree rotation, showing combination of 2 vars yields separation improvement by factor $\sqrt{2}$, showing i.i.d. vars are not truly redundant. 
For further details, see \citebutton{Guyon and Elisseeff, 2003}{https://www.jmlr.org/papers/volume3/guyon03a/guyon03a.pdf}.}
