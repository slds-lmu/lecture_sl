...
% \end{minipage}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{figure}
        \centering
        %\includegraphics[width=0.98\textwidth]{figure/filter_comparison_har_classif.kknn.png}
        \includegraphics[width=0.98\textwidth, height=0.45\textheight]{figure/fs-filters-scree-plot.png} % second figure itself  
      \end{figure}
    \end{column}
