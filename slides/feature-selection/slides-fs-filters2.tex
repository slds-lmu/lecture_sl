...
\begin{document}
  ...
  \lecturechapter{Filter Methods: Examples and Caveats}
  ...
  \setlength{\itemsep}{0.8em}
    ...
    \item FM is strongly related to variable importance methods.
  \end{itemize}
\vspace{-0.2cm}
  \begin{center}
  \begin{figure}
    \includegraphics[width=0.58\textwidth]{figure/filter_comparison_har_classif.kknn.png}
  \end{figure}
  \end{center}
...
% \end{minipage}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{figure}
        \centering
          \includegraphics[width=0.98\textwidth, height=0.5\textheight]{figure/fs-filters-scree-plot.png} % second figure itself  
      \end{figure}
    \end{column}
