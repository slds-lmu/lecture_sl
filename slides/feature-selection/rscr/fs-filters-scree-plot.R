...
p <- ggplot(ranked_features, aes(x = 1:nrow(ranked_features), y = score)) +
  ...
  labs(title = "Feature Score and logistic regression model performance", x = "Feature rank/ Features used in the model",)
...
# save the plot
ggsave("slides/feature-selection/figure/fs-filters-scree-plot.png", plot, width = 20, height = 12, units = "cm")
