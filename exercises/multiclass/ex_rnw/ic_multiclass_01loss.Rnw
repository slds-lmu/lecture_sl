    ...
    \item
	  ...
	  \item  
	    What is its theoretical risk? (Hint: $\sum_{i=1}^{10} \frac{1}{i} = \frac{7381}{2520}$)
	    \lz
	    \lz
	    \lz 
	    \lz
	  ...
	  \item
	    What is $\bar h,$ i.e., the optimal constant model in terms of the theoretical risk we derived on Exercise Sheet 02?
	    \lz
	    \lz 
	    \lz 
	    \lz
