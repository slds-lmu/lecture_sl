    ...
    \item 
        ...
        \begin{equation} \label{eq:solve_c}
            \begin{aligned}
                ...
                & = - \frac{\sigma_0^2 + \mu_0^2}{2\sigma^2} + \frac{\mu \mu_0}{\sigma^2} - \frac{\mu^2}{2\sigma^2}
            \end{aligned}
        \end{equation}
        ...
        \begin{equation} \label{eq:final_b}
            \begin{aligned}
                (b) = -log  \sqrt{\sigma^2 2 \pi } - \frac{\sigma_0^2 + \mu_0^2}{2\sigma^2} + \frac{\mu \mu_0}{\sigma^2} - \frac{\mu^2}{2\sigma^2}
            \end{aligned}
        \end{equation}
        ...
        As the second derivative is less than 0 at any point, $\mu_{opt}$ minimizes the Kullback-Leibler divergence. We now derive with respect to the variance parameter $\sigma^2$:

        \begin{equation}
            \begin{aligned}
                \frac{\partial (b)}{\partial \sigma^2} &= - \frac{1}{2\sigma^2}
                    + \frac{\sigma_0^2 + \mu_0^2}{2\sigma^4}
                    - \frac{\mu \mu_0}{\sigma^4}
                    + \frac{\mu^2}{2\sigma^4} \\
                &= - \frac{1}{2\sigma^2} + \frac{\sigma_0^2 + \mu_0^2 - 2 \mu \mu_0 + \mu^2}{2\sigma^4} \\
                &= - \frac{1}{2\sigma^2} + \frac{\sigma_0^2 + (\mu - \mu_0)^2}{2\sigma^4} \overset{!}{=} 0 \longrightarrow \sigma_{opt}^2 = \sigma_0^2 + (\mu - \mu_0)^2 \\
            \end{aligned}
        \end{equation}
        ...
        \begin{equation}
            \begin{aligned}
                \frac{\partial^2 (b)}{\partial^2 \sigma^2} &= \frac{1}{2\sigma^4}- \frac{ (\sigma_0^2 + (\mu - \mu_0)^2)}{\sigma^6} \\
                \frac{\partial^2 (b)}{\partial^2 \sigma^2}\Big|_{\sigma^2 = \sigma_{opt}^2} &= \frac{1}{ 2 (\sigma_0^2 + (\mu - \mu_0)^2))^2} - \frac{1}{(\sigma_0^2 + (\mu - \mu_0)^2))^2} < 0
            \end{aligned}
        \end{equation}

        As the second derivative is less than 0 at the point we are looking, $\sigma_{opt}^2$ minimizes the Kullback-Leibler Divergence. 
