...
\begin{enumerate}
    \item 
        What is $\E[\|X\|_1]?$ (Hint: $\E|X_i|=\sqrt{\frac{2}{\pi}}.$)
        \lz
        \lz
        \lz
        \lz
    ...
    \item 
        What is $\var[\|X\|_1]?$ (Hint: $\var|X_i|=1-\frac{2}{\pi}.$)
        \lz
        \lz
        \lz
        \lz
    ...
    \item 
        ...
        \lz
    \item
        Let $\xv=(x_1,\ldots,x_p)^\top \in \R^p$  be some arbitrary deterministic vector. 
        Compute $\E\langle X,\xv \rangle$ and $\var(\langle X,\xv \rangle).$
        \lz
        \lz
        \lz
        \lz
