...
::: callout-tip
You can run the notebooks in Google Colab here: [R](https://colab.research.google.com/github/slds-lmu/lecture_sl/blob/main/exercises/regularization-quarto/inserted/sol_regularization_1_R.ipynb), [Python](https://colab.research.google.com/github/slds-lmu/lecture_sl/blob/main/exercises/regularization-quarto/inserted/sol_regularization_1_py.ipynb).
:::
:::
...
::: {.panel-tabset}
### R
{{< embed sol_regularization_1_R.ipynb#underdetermined_inv_solve echo=true >}}
...
::: {.panel-tabset}
### R
{{< embed sol_regularization_1_R.ipynb#early_stopping_package_install_R echo=true >}}
