\begin{enumerate}
    \item 
        ...
        \begin{itemize}
            ...
            \item 
                The norm of $\thetab$ can be calculated as :

                $$
                    \| \thetab \| = \frac{1}{\gamma} = \frac{1}{1} = 1
                $$
            \item
            ...
            Using the formula $ \thetab^T x + \theta_0  = 0 $, we obtain that $\theta_1$ = 1, $\theta_2 = 0$ and $\theta_0=-5$
            \item 
    ...
    \item
      ...
      \begin{itemize}
        \item 
          ...
          The safety margin $\gamma$ and thus the norm of $\thetab$ remain the same. 
          However, the direction of $\thetab$ changed because of the rotation.
          ...
          \item
            ...
            If one SV moves closer to the bound $(6,1) \rightarrow (5.5,1)$ :
            ...
            The margin $\gamma$ is now smaller, and thus $\| \thetab \|$ is bigger. 
            The direction of $\thetab$ and $\theta_0$ remain the same. 
        ...
        \item 
            ...
            The margin $\gamma$ increases, and thus $\| \thetab \|$ will decrease. 
            The direction of $\thetab$ remains the same but $\theta_0$ changes.
...
$\gamma$ & $ \| \thetab \| $ & $ \thetab $                  & $\theta_0$ & SV                   \\ \hline
1        & 1                 & $\frac{1}{\sqrt{2}} (1,1)^T$ & -5         & Rotation ($(4,1)^T, (6,1)^T$)                 \\
1        & 1                 & $(1,0)^T$                    & -7         & $(6,1)^T, (8,1)^T  $               \\
0.75     & 1.25              & $ (1.25,0)^T$                & -4.75      & $(4,1)^T, (6,1)^T   $             \\
1.25     & 0.75              & $ (0.75,0)^T$                & -5.25      & $(4,1)^T, (6.5,1)^T$
\end{tabular}
\end{table}
